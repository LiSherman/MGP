...
parser.add_argument('--exp', type=str,
                    default='ACDC/ANFC', help='experiment_name')
...
def Inference(FLAGS):
    ...
    save_mode_path = '/mnt/disk1/lsm/workspace/semi/MajorRevision/git_version/model/ACDC/ACT_3_labeled/unet_best_model.pth'
